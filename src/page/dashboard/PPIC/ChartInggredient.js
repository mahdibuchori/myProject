...
export const ChartInggredient = (props) => {
    ...
    const onGridReady = (x) =>{
        ...
        const result = dataInggredient.filter((v,i,a)=>a.findIndex(v2=>(v2.bulan===v.bulan))===i);
        ...
        let material = inggredient.map(d => { 
        ...
        if(material.length > 0){
            let nama = dataInggredient[0].value;
            const postIds = dataInggredient.map((e) => {
                return(
