...
export const ParetoDaging = (props) => {
    ...
    const onGridReady = () =>{
        ...
        if(year > 2022 && year <2024){
            const data = dataDaging.filter(x => x.bulan === buls[month]);
    ...
    return (
        <>
            <h6 className=''>Top 10 Monthly Daging</h6>
            <div>
                <ListGroup numbered>
                    {fileName.map((e, i) =>{
                        return(
                            <ListGroup.Item
                                ...
                                onClick={() => {props.sendToParentDag(e.item)}}
                            >
