...
export const ChartPackaging = (props) => {
    ...
    const onGridReady = (x) =>{
        ...
        const result = dataPackaging.filter((v,i,a)=>a.findIndex(v2=>(v2.bulan===v.bulan))===i);
        ...
        if(material.length > 0){
            let nama = dataPackaging[0].value;
            const postIds = dataPackaging.map((e) => {
                return(
