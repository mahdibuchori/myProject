      ...
      const onGridReady = (x) =>{
        ...
        if(material.length > 0){
            ...
            let dWeek1 = listData.map((d)=>{
                let nilai = 0
                if(d.week1S === ''){nilai = 0}else{ nilai = parseFloat(d.week1S)}
                return(
                    nilai
                )
            })
            let dWeek2 = listData.map((d)=>{
                let nilai = 0
                if(d.week2S === ''){nilai = 0}else{ nilai = parseFloat(d.week2S)}
                return(
                    nilai
                )
            })
            let dWeek3 = listData.map((d)=>{
                let nilai = 0
                if(d.week3S === ''){nilai = 0}else{ nilai = parseFloat(d.week3S)}
                return(
                    nilai
                )
            })
            let dWeek4 = listData.map((d)=>{
                let nilai = 0;
                if(d.week4S === ''){nilai = 0}else{ nilai = parseFloat(d.week4S)}
                return(
                    nilai
                )
            })
            let dWeek5 = listData.map((d)=>{
                let nilai = 0;
                if(d.week5S === ''){nilai = 0}else{ nilai = parseFloat(d.week5S)}
                return(
                    nilai
                )
            })
    ...
    <>
        <div className='card-h-50 card mt-2'>
            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
                <h6 className=''>REPORT PER MINGGU FG - PENJUALAN</h6>
                <h6>{nabar}</h6>
