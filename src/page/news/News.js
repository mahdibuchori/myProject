...
export const News = () => {
  return (
    <div className='newsSet'>
        <div className="container">
            <div className="row align-items-center event-block no-gutters margin-40px-bottom mb-3 bs-box shadow-lg">
                <div class="col-lg-5 col-sm-12">
                    <div class="position-relative">
                        <img src="https://www.bootdey.com/image/350x180/FFB6C1/000000" alt=""/>
            ...
            <div className="row align-items-center event-block no-gutters margin-40px-bottom mb-3 bs-box shadow-lg">
                ...
                <div class="col-lg-5 order-1 order-lg-2">
                    <div class="position-relative">
                        <img src="https://www.bootdey.com/image/350x180/87CEFA/000000" alt=""/>
                        <div class="events-date">
            ...
            <div className="row align-items-center event-block no-gutters margin-40px-bottom mb-3 bs-box shadow-lg">
                <div class="col-lg-5 col-sm-12">
                    <div class="position-relative">
                        <img src="https://www.bootdey.com/image/350x180/B0C4DE/000000" alt=""/>
                        <div class="events-date">
            ...
            <div className="row align-items-center event-block no-gutters margin-40px-bottom mb-3 bs-box shadow-lg">
                ...
                <div class="col-lg-5 order-1 order-lg-2">
                    <div class="position-relative">
                        <img src="https://www.bootdey.com/image/350x180/7B68EE/000000" alt=""/>
                        <div class="events-date">
                            <div class="font-size28">25</div>
